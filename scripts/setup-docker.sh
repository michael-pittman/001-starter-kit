#!/usr/bin/env bash
# =============================================================================
# Docker Setup Compatibility Wrapper
# Redirects to setup-suite.sh for Docker setup functionality
...
echo "INFO: Redirecting to setup suite for Docker setup..." >&2
"$SETUP_SUITE" --component docker "$@" 